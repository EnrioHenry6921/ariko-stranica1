...
export const patternDetails: Record<string, PatternDetail> = {
  ...
  "birkin-25": {
    ...
    materialsHr: "Merino pređa, igla 3.5 mm", materialsEn: "Merino yarn, 3.5 mm hook",
    descHr: "Manja verzija strukturirane torbe s preklopom — ista čvrsta baza i zlatni detalji, u kompaktnijem formatu. Uključuje sheme za oba ovješenja ručke.",
    descEn: "A smaller version of the structured flap bag — the same firm base and gold details in a more compact format. Includes charts for both handle attachments.",
  },
  "mini-kelly": {
  ...
  "skirt-bag": {
    ...
    materialsHr: "Pamučni konac, igla 4 mm", materialsEn: "Cotton thread, 4 mm hook",
    descHr: "Razigrana torbica nabranog, plisiranog oblika. Prozračna struktura s ritmom nabora — upute vode kroz svaki pregib.",
    descEn: "A playful bag with a pleated, skirt-like shape. An airy structure with a rhythm of folds — the instructions walk through every pleat.",
  },
};
