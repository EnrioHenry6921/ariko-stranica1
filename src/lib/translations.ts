...
export const translations: Record<Lang, Translations> = {
  hr: {
    ...
    omeniP2: "Ako želiš nešto sasvim po svom, javi mi se i dogovorit ćemo boje, veličinu i detalje.",
  ...
  en: {
    ...
    omeniP2: "If you'd like something entirely your own, message me and we'll agree on colors, size and details.",
