...
export const translations: Record<Lang, Translations> = {
  hr: {
    ...
    heroLead: "Ručno izrađene torbe u malim serijama, od prirodnih i recikliranih materijala. Cijene od €40.",
    ...
    omeniEyebrow: "O meni",
    omeniP1: "Svaku torbu heklam sama, u malim serijama. Radim s prirodnim i recikliranim materijalima jer volim da svaka torba ima svoju priču — i da traje.",
    ...
    footerBlurb: "Ručno heklane torbe i digitalni uzorci. Male serije, prirodni i reciklirani materijali.",
  ...
  en: {
    ...
    heroLead: "Handmade bags in small batches, from natural and recycled materials. Prices from €40.",
    ...
    omeniP1: "I crochet every bag myself, in small batches. I work with natural and recycled materials because I love for every bag to have its own story — and to last.",
    ...
    footerBlurb: "Hand-crocheted bags and digital patterns. Small batches, natural and recycled materials.",
